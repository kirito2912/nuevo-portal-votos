  ...
  const resultsData: Record<TabId, ResultsView> = useMemo(
    () => ({
      presidencial: {
        ...
        chart: [
          { name: 'Keiko Fujimori', votes: 12850, participation: 42 },
          { name: 'Rafael López Aliaga', votes: 11240, participation: 38 },
          { name: 'César Acuña', votes: 10999, participation: 35 },
        ],
        topCandidates: [
          {
            id: 1,
      ...
      regional: {
        ...
        chart: [
          { name: 'Ana María Torres', votes: 10250, participation: 52 },
          { name: 'Miguel Ángel Castro', votes: 9306, participation: 48 },
        ],
        topCandidates: [
          {
            id: 4,
      ...
      distrital: {
        ...
        chart: [
          { name: 'Carlos Rojas', votes: 4520, participation: 51 },
          { name: 'Patricia Silva', votes: 4364, participation: 49 },
        ],
        topCandidates: [
          {
            id: 6,
